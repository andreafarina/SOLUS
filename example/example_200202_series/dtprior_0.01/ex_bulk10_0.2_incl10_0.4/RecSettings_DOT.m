...
% -------------------------------------------------------------------------
REC.time.roi = [200 700;200 700;200 700;200 700;200 700;200 700;200 700;200 700];
...
%%                            US prior 
% =========================================================================
REC.solver.prior.path = ['/scratch0/NOT_BACKED_UP/gdisciac/SOLUS_spectralfitUCL/example/example_200202_series/dtprior/DTUS_image_dicom_3D.mat']%['DTsilicon_mask.mat'];%;['ham_maskYX_flip.mat'];
% =========================================================================
