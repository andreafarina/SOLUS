% Init_DOT for measurements on the dynamic phantom.
disp(spacer);
disp('SOLUS: Measurements on Dynamic phantom');
disp(spacer);
%==========================================================================
%%                              OPTIONS 
%==========================================================================
...
DOT.opt.muaB = 0.012;    % mm-1
DOT.opt.muspB = 1.12;      % mm-1
DOT.opt.nB = 1.5;       % internal refractive index   
