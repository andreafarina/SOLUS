...
% -------------------------------------------------------------------------
REC.time.roi = [200,583];% ROI in time-step unit. If omitted, the ROI will be 
...
% --------------------------- Optical properties --------------------------
REC.opt.mua0 = 0.0038;%0.0004;%0.0036;%0.0004;    % absorption [mm-1]
REC.opt.musp0 = 0.9966;%0.37;%1.05;%0.39;      % reduced scattering [mm-1]
REC.opt.nB = 1.4;
