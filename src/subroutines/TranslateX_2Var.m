...
switch SPECTRA
    ...
    case 1
        ...
        ab = Xd{ab_pos};
        DOT.opt.aB = ab(a_pos); DOT.opt.bB = ab(b_pos); DOT.opt.concB = Xd{conc_pos};
        ...
        ab = Xr{ab_pos};
        REC.opt.a0 = ab(a_pos); REC.opt.b0 = ab(b_pos); REC.opt.conc0 = Xr{conc_pos};
        ...
        if numel(DOT.opt.hete1.type) == 2
            ab = Xp{ab_pos};
            DOT.opt.hete1.a = ab(a_pos); DOT.opt.hete1.b = ab(b_pos); DOT.opt.hete1.conc = Xp{conc_pos};
        ...
        elseif strcmpi(DOT.opt.hete1.type,'mua')
            DOT.opt.hete1.conc = Xp{1};
            if isrow(DOT.opt.hete1.conc), DOT.opt.hete1.conc = DOT.opt.hete1.conc'; end
            CheckDataConsistency;
            absorption = ext_coeffB*DOT.opt.hete1.conc;
            if iscolumn(absorption), absorption = absorption'; end
