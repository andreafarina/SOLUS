function ImageMeasure(DOT,imS,imQ,dmask)%% plot sources
figure(485)
...
scatter(DOT.Source.Pos(imQ,1),DOT.Source.Pos(imS,2),'r','filled')
scatter(DOT.Detector.Pos(imS,1),DOT.Detector.Pos(imQ,2),'r','filled')
title(['Measure #', num2str(imS),'-', num2str(imQ)])
