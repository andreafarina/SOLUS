...
%% Read .DAT files
% Measurement file
filepath = 'Dati phantom silicone/Data_hete_10_0.1_1cm';
...
T.opt.homo.abs = [0.0052110235	0.0046931605	0.0058062775	0.004645077	0.0102011626	0.0103513675	0.0053529552	0.0091815293];
T.opt.homo.sca = [1.21313875	1.0824840679	0.9502801321	0.8409292679	0.6553046464	0.5829951214	0.5310619036	0.514882275];
...
%Irf file
irf = DatRead2(irf_file_name,4096,5,8);  
    if sum_rep == 0 
